...
complete_df <- read.csv("E:/Microfractures paper/Datasets/Finalized_dataset.csv")
...
#mean_train <- train_df_transformed %>% dplyr::select(c(5:11)) %>% apply(., 2, mean) #the 2 arg indicates columns, 1 indicates rows
#sd_train <- train_df_transformed %>% dplyr::select(c(5:11)) %>% apply(., 2, sd)
...
write.csv(label_df_NT, "Label_df_NT.csv")
write.csv(train_df_NT, "Train_df_NT.csv")
...
ggsave("D:/PhD projects/Microfractures paper/images/sec_label_barplot.svg", sec_label_barplot, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_solidity_hist.svg", w1, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_compactness_hist.svg", w2, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_formfactor_hist.svg", w3, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_extent_hist.svg", w4, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_circularity_hist.svg", w5, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_roundness_hist.svg", w6, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/whole_AR_hist.svg", w7, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_solidity_hist.svg", p1, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_compactness_hist.svg", p2, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_formfactor_hist.svg", p3, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_extent_hist.svg", p4, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_circularity_hist.svg", p5, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_roundness_hist.svg", p6, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_raw_AR_hist.svg", p7, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_transfo_formfactor_hist.svg", t3, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_transfo_roundness_hist.svg", t6, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/TT_transfo_AR_hist.svg", t7, width = 8, height = 6, device = "svg")

final_label_hist <- grid.arrange(t1, t2, t3, t4, t5, t6, t7, ncol = 3)


ggsave("D:/PhD projects/Microfractures paper/final_label_hist.svg", final_label_hist, width = 16, height = 12, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/train_label_boxplot.svg", sec_label_boxplot, width = 8, height = 6, device = "svg")
```
...
ggsave("D:/PhD projects/Microfractures paper/images/train_corr_plot.svg", cor_plot, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/Figure 7-PCA plots/whole_biplot_unlabel.svg", whole_biplot_unlabel, width = 12, height = 10, device = "svg")

ggsave("D:/PhD projects/Microfractures paper/images/Figure 7-PCA plots/whole_biplot_label.svg", whole_biplot_label, width = 12, height = 10, device = "svg")

ggsave("D:/PhD projects/Microfractures paper/images/Figure 7-PCA plots/sec_label_biplot.svg", sec_label_biplot, width = 12, height = 10, device = "svg")

ggsave("D:/PhD projects/Microfractures paper/images/Figure 7-PCA plots/prim_label_biplot.svg", prim_label_biplot, width = 12, height = 10, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/hpo_grid.svg", hpo_grid, width = 12, height = 16, device = "svg")

```


```{r Visualizing decision boundaries}

# Calculate the mean values for the unused features from the training set
mean_solidity <- mean(train_df_NT$solidity)
mean_extent <- mean(train_df_NT$extent)
mean_formfactor <- mean(train_df_NT$formfactor)

# Calculate the range of aspect_ratio and compactness in the training data
min_aspect_ratio <- min(train_df_NT$aspect_ratio)
max_aspect_ratio <- max(train_df_NT$aspect_ratio)
min_compactness <- min(train_df_NT$compactness)
max_compactness <- max(train_df_NT$compactness)

# Extend the range of aspect_ratio in the grid
extended_max_aspect_ratio <- 1.5 * max_aspect_ratio  # Adjust the factor as needed
grid_df <- expand.grid(
  aspect_ratio = seq(min_aspect_ratio, extended_max_aspect_ratio, length.out = 300),
  compactness = seq(min_compactness, max_compactness, length.out = 300)
)

# Assign the mean values to the other features
grid_df$solidity <- rep(mean_solidity, nrow(grid_df))
grid_df$extent <- rep(mean_extent, nrow(grid_df))
grid_df$formfactor <- rep(mean_formfactor, nrow(grid_df))

# Scale the aspect_ratio and compactness features with the same parameters as used in training
grid_df$aspect_ratio <- scale(grid_df$aspect_ratio, center = attr(train_df_NT$aspect_ratio, "scaled:center"), scale = attr(train_df_NT$aspect_ratio, "scaled:scale"))
grid_df$compactness <- scale(grid_df$compactness, center = attr(train_df_NT$compactness, "scaled:center"), scale = attr(train_df_NT$compactness, "scaled:scale"))

# Add the scaling attributes to the solidity, extent, and formfactor features
grid_df$solidity <- scale(grid_df$solidity, center = attr(train_df_NT$solidity, "scaled:center"), scale = attr(train_df_NT$solidity, "scaled:scale"))
grid_df$extent <- scale(grid_df$extent, center = attr(train_df_NT$extent, "scaled:center"), scale = attr(train_df_NT$extent, "scaled:scale"))
grid_df$formfactor <- scale(grid_df$formfactor, center = attr(train_df_NT$formfactor, "scaled:center"), scale = attr(train_df_NT$formfactor, "scaled:scale"))

  # Predict using the grid
  grid_df$Type <- predict(qda_model, newdata = grid_df, type = "raw")
  
  # Convert to factor for plotting
  grid_df$Type <- factor(grid_df$Type, levels = levels(train_df_NT$Type))
  
  
  db_plot <- ggplot() +
    geom_tile(data = grid_df, aes(x = aspect_ratio, y = compactness, fill = Type), alpha = 0.5) +
    geom_point(data = subset(test_df_NT, Type == 'Pore'), aes(x = aspect_ratio, y = compactness, shape = Type), 
               size = 3, stroke = 0.5, color = 'black', fill = "#2D69A9", alpha = 0.7) +
    geom_point(data = subset(test_df_NT, Type == 'Crack'), aes(x = aspect_ratio, y = compactness,  color = Type, shape = Type), 
               size = 3, stroke = 0.5, alpha = 0.7, fill = "#DE0018",) +
    scale_shape_manual(values = c('Crack' = 25, 'Pore' = 21)) +
    scale_fill_manual(values = c('Crack' = "maroon", 'Pore' = "skyblue")) +
    scale_color_manual(values = c('Crack' = "black", 'Pore' = "black"), name = "Color Legend Title") + # Dummy scale for separate legend
    labs(title = "Decision Boundary Plot for Quadratic Discriminant Analysis", x = "Aspect Ratio", y = "Compactness") +
    theme_few() + 
    guides(fill = guide_legend(title = "Fill"), shape = guide_legend(title = "Shape"))
  
  
  ggsave("E:/Microfractures paper/Figures/Decision Boundary plots/qda_db.pdf", db_plot, width = 12, height =8, device = "pdf")
...
ggsave("D:/PhD projects/Microfractures paper/images/sec_prob_grid.svg", polysvm_plot, width = 8, height = 6, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/Figure 9 - ROC curve + Acc boxplot/acc_boxplot.svg", acc_boxplot, width = 10, height = 8, device = "svg")
...
ggsave("D:/PhD projects/Microfractures paper/images/Figure 10 - Shap plot + Extent uselessness/shap_grid.svg", shap_grid, width = 8, height = 6, device = "svg")
```

Thomas raised this idea which I was also thinking about. Maybe include both the training and testing data. The idea is to show the high-bias of the feature space as most models will show quite similar trends in this space.
```{r Fig____ Bivariate plots of compactness and AR showing the likely decision boundaries, echo=FALSE}
...
```{r Fig S___ Examples of the combined HSB and LAB segmentation, echo=FALSE}

```



The outlier detection diagram can be split into the following components; an example crop of a selected outlier, the boxplot, the scatter plot, with the plots showing the datapoint in the image. Mention in the text that outlier detection was performed prior to the training-testing split.
```{r Fig S__ Outlier detection diagram, echo=FALSE}


```

```{r Fig S__ Learning curves for all models, echo=FALSE}
